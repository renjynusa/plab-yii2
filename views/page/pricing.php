    ...
    <div class="col-lg-4 col-md-6">
        <div class="pricing-table mb-30">
            <div class="relative">
                ...
                <h2 class="price">$100 <span>par month</span></h2>
            </div>
            <div class="pricing-content">
                <h3 class="title purple-text">Standard</h3>
                <ul>
                ...
                <a class="signup purple-bg" href="#">Signup Now</a>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-4 col-md-6">
        <div class="pricing-table mb-4">
            <div class="relative">
                ...
                <h2 class="price">$120 <span>par month</span></h2>
            </div>
            <div class="pricing-content">
                <h3 class="title primary-text">BUSINESS</h3>
                <ul>
                ...
                <a class="signup primary-bg" href="#">Signup Now</a>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-4 col-md-6 offset-lg-0 offset-md-3">
        <div class="pricing-table mb-4">
            <div class="relative">
                ...
                <h2 class="price">$150<span>par month</span></h2>
            </div>

            <div class="pricing-content">
                <h3 class="title danger-text">PREMIUM</h3>
                <ul>
                ...
                <a class="signup danger-bg" href="#">Signup Now</a>
            </div>
        </div>
    </div>
</div>
