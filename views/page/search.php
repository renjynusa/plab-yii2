            ...
            <div class="card-body p-30">
                ...
                <ul class="top-rated-products search-result">
                    <li class="single-product">
                        <a href="#">
                            <?= Html::img('@web/images/product/product1.jpg', ['alt' => 'Apple iPhone XR']); ?>
                        </a>
                    ...
                    <li class="single-product">
                        <a href="#">
                            <?= Html::img('@web/images/product/product2.jpg', ['alt' => 'Apple iPhone XR Black']); ?>
                        </a>
                    ...
                    <li class="single-product">
                        <a href="#">
                            <?= Html::img('@web/images/product/product3.jpg', ['alt' => 'HeadPhone']); ?>
                        </a>
                    ...
                    <li class="single-product">
                        <a href="#">
                            <?= Html::img('@web/images/product/product5.jpg', ['alt' => 'Shoes']); ?>
                        </a>
                    ...
                    <li class="single-product">
                        <a href="#">
                            <?= Html::img('@web/images/product/product4.jpg', ['alt' => 'HeadPhone']); ?>
                        </a>
                        <a class="product-title" href="#">HeadPhone</a>
                        <p>There are many variations of passages...</p>
                        <div class="price mr-2">
                    ...
                    <li class="single-product">
                        <a href="#">
                            <?= Html::img('@web/images/product/product1.jpg', ['alt' => 'Apple iPhone XR 2']); ?>
                        </a>
                        <a class="product-title" href="#">Apple iPhone XR</a>
                        <p>There are many variations of passages...</p>
                        <div class="price mr-2">$599</div>
