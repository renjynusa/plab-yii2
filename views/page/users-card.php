...
<div class="row">
    ...
    <div class="col-lg-4 col-md-6">
        <div class="single-user-card hover-card mb-30">
            <div class="p-30">
                <?= Html::img('@web/images/user/big/2.png', ['alt' => 'User Image', 'class' => 'rounded-circle']); ?>
    ...
    <div class="col-lg-4 col-md-6 offset-lg-0 offset-md-3">
        <div class="single-user-card hover-card mb-30">
            <div class="p-30">
                <?= Html::img('@web/images/user/big/3.png', ['alt' => 'User Image', 'class' => 'rounded-circle']); ?>
...
<div class="row">
    <div class="col-lg-4 col-md-6">
        <div class="single-user-card hover-card mb-30">
            <div class="p-30">
                <?= Html::img('@web/images/user/big/4.png', ['alt' => 'User Image', 'class' => 'octagon-style']); ?>
                <h4 class="mb-0 mt-4">Frank Martin</h4>
                <p>Managing Director</p>
                <div class="social-links">
                    <a href="#">
    ...
    <div class="col-lg-4 col-md-6">
        <div class="single-user-card hover-card mb-30">
            <div class="p-30">
                <?= Html::img('@web/images/user/big/5.png', ['alt' => 'User Image', 'class' => 'octagon-style']); ?>
                <h4 class="mb-0 mt-4">Christopher Di</h4>
                <p>Web Developer</p>
                <div class="social-links">
                    <a href="#">
    ...
    <div class="col-lg-4 col-md-6 offset-lg-0 offset-md-3">
        <div class="single-user-card hover-card mb-30">
            <div class="p-30">
                <?= Html::img('@web/images/user/big/6.png', ['alt' => 'User Image', 'class' => 'octagon-style']); ?>
                <h4 class="mb-0 mt-4">Nancy Doe</h4>
                <p>Designer</p>
                <div class="social-links">
                    <a href="#">
...
<div class="row">
    <div class="col-lg-4 col-md-6">
        <div class="single-user-card hover-card mb-30">
            <div class="p-30">
                <?= Html::img('@web/images/user/big/1.png', ['alt' => 'User Image', 'class' => 'nonagon-style']); ?>
                <h4 class="mb-0 mt-4">Frank Martin</h4>
                <p>Managing Director</p>
                <div class="social-links">
                    <a href="#">
    ...
    <div class="col-lg-4 col-md-6">
        <div class="single-user-card hover-card mb-30">
            <div class="p-30">
                <?= Html::img('@web/images/user/big/2.png', ['alt' => 'User Image', 'class' => 'nonagon-style']); ?>
                <h4 class="mb-0 mt-4">Christopher Di</h4>
                <p>Web Developer</p>
                <div class="social-links">
                    <a href="#">
    ...
    <div class="col-lg-4 col-md-6 offset-lg-0 offset-md-3">
        <div class="single-user-card hover-card mb-30">
            <div class="p-30">
                <?= Html::img('@web/images/user/big/3.png', ['alt' => 'User Image', 'class' => 'nonagon-style']); ?>
                <h4 class="mb-0 mt-4">Nancy Doe</h4>
                <p>Designer</p>
                <div class="social-links">
                    <a href="#">
...
<div class="row">
    <div class="col-lg-4 col-md-6">
        <div class="single-user-card hover-card mb-30">
            <div class="p-30">
                <?= Html::img('@web/images/user/big/4.png', ['alt' => 'User Image', 'class' => 'bevel-style']); ?>
                <h4 class="mb-0 mt-4">Frank Martin</h4>
                <p>Managing Director</p>
                <div class="social-links">
                    <a href="#">
    ...
    <div class="col-lg-4 col-md-6">
        <div class="single-user-card hover-card mb-30">
            <div class="p-30">
                <?= Html::img('@web/images/user/big/5.png', ['alt' => 'User Image', 'class' => 'bevel-style']); ?>
                <h4 class="mb-0 mt-4">Christopher Di</h4>
                <p>Web Developer</p>
                <div class="social-links">
                    <a href="#">
    ...
    <div class="col-lg-4 col-md-6 offset-lg-0 offset-md-3">
        <div class="single-user-card hover-card mb-30">
            <div class="p-30">
                <?= Html::img('@web/images/user/big/6.png', ['alt' => 'User Image', 'class' => 'bevel-style']); ?>
                <h4 class="mb-0 mt-4">Nancy Doe</h4>
                <p>Designer</p>
                <div class="social-links">
                    <a href="#">
