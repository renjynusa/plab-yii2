	...
	<div class="col-lg-8">
		<div class="card mb-30">
			<div class="card-body">
				...
				<div class="m-t-30">
					<div class="d-md-flex">
						<div class="pr-4 mt-2 border-right border-hide-sm">
							<p class="mb-0 fs-13">Net Revenue</p>
							<h5 class="mb-0">
								<span>$50,525</span>
								<span class="primary-text ml-1 fs-13">+8.71%</span>
							</h5>
						</div>

						<div class="px-md-4 mt-2 border-right border-hide-md">
							<p class="mb-0 fs-13">Selling</p>
							<h5 class="mb-0">
								<span>$20,520</span>
								<span class="danger-text m-l-10 fs-13">+2.82%</span>
							</h5>
						</div>

						<div class="px-md-4 mt-2">
							<p class="mb-0 fs-13">Cost</p>
							<h5 class="mb-0">
								<span>$7,317</span>
								<span class="primary-text ml-1 fs-13">+10.2%</span>
							</h5>
						</div>
					</div>
				</div>

				<!-- File path: assets/js/apex-charts/order-summary.js -->
	...
	<div class="col-lg-4">
		<div class="card mb-30">
			<div class="card-body">
				...
				<p class="mb-0">Overview of orders. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor.</p>

				<div class="order-stats-card mt-4">
				...
				<div class="order-stats-card mt-4">
					<h3 class="mb-1">Failed</h3>
					<div class="d-flex justify-content-between">
						<div class="d-flex align-items-center">
							<span>Monthly Goal</span>
						</div>
						<span class="fw-600">30%</span>
					</div>
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="order-number-stats mt-4">
							<span class="number text-primary fw-600">79885</span>
							<p>Success</p>
						</div>
					</div>
					<div class="col-sm-4">
						<div class="order-number-stats mt-4">
							<span class="number text-warning fw-600">356</span>
							<p>Pending</p>
						</div>
					</div>
					<div class="col-sm-4">
						<div class="order-number-stats mt-4">
							<span class="number text-danger fw-600">265</span>
							<p>Failed</p>
						</div>
					</div>
				</div>
...
<div class="row">
			...
			<div class="card-body">
				...
				<div class="new-customer">
					<a class="profile mr-3" href="#">
						<?= Html::img('@web/images/user/1.jpg', ['alt' => 'User', 'class' => 'rounded-circle']); ?>
						<span class="status online right-3 bottom"></span>
					</a>
					<h5 class="fs-13 m-0">
						<a class="global-color" href="#">
							Amber Gibs
						</a>
					</h5>
					<span class="gray-color fs-11">2 Minutes ago</span>
					<span class="price">$2,000</span>
				</div>

				<div class="new-customer">
					<a class="profile mr-3" href="#">
						<?= Html::img('@web/images/user/2.jpg', ['alt' => 'User', 'class' => 'rounded-circle']); ?>
						<span class="status online right-3 bottom"></span>
					</a>
					<h5 class="fs-13 m-0">
						<a class="global-color" href="#">Carl Roland</a>
					</h5>
					<span class="gray-color fs-11">3 Minutes ago</span>
					<span class="price">$3,000</span>
				</div>

				<div class="new-customer">
					<a class="profile mr-3" href="#">
						<?= Html::img('@web/images/user/3.jpg', ['alt' => 'User', 'class' => 'rounded-circle']); ?>
						<span class="status online right-3 bottom"></span>
					</a>
					<h5 class="fs-13 m-0">
						<a class="global-color" href="#">Paul Wilson</a>
					</h5>
					<span class="gray-color fs-11">4 Minutes ago</span>
					<span class="price">$4,000</span>
				</div>

				<div class="new-customer">
					<a class="profile mr-3" href="#">
						<?= Html::img('@web/images/user/4.jpg', ['alt' => 'User', 'class' => 'rounded-circle']); ?>
						<span class="status online right-3 bottom"></span>
					</a>
					<h5 class="fs-13 m-0">
						<a class="global-color" href="#">Alice Jenkins</a>
					</h5>
					<span class="gray-color fs-11">5 Minutes ago</span>
					<span class="price">$5,000</span>
				</div>

				<div class="new-customer">
					<a class="profile mr-3" href="#">
						<?= Html::img('@web/images/user/5.jpg', ['alt' => 'User', 'class' => 'rounded-circle']); ?>
						<span class="status away right-3 bottom"></span>
					</a>
					<h5 class="fs-13 m-0">
						<a class="global-color" href="#">Lauren Cox</a>
					</h5>
					<span class="gray-color fs-11">5 Minutes ago</span>
				...
				<div class="new-customer">
					<a class="profile mr-3" href="#">
						<?= Html::img('@web/images/user/6.jpg', ['alt' => 'User', 'class' => 'rounded-circle']); ?>
						<span class="status ofline right-3 bottom"></span>
					</a>
					<h5 class="fs-13 m-0">
						<a class="global-color" href="#">Jessie Barnett</a>
					</h5>
					<span class="gray-color fs-11">5 Minutes ago</span>
	...
	<div class="col-lg-8">
		<div class="card mb-30">
			<div class="card-body">
				<div class="card-header">
					<h5 class="card-title">Price Movements</h5>
				</div>

				<!-- File path: assets/js/apex-charts/apex-area-chart.js -->
...
<!-- Products of the Month & Order Stats -->
<div class="row">
			...
			<div class="card-body">
				...
				<div class="marketing-content">
					...
					<div class="list">
						...
						<div class="stats">
							<i data-feather="trending-up" class="icon text-danger"></i>
							25%
						</div>
					</div>
					<div class="list">
